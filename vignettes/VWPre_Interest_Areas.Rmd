...
vignette: >
  %\VignetteIndexEntry{Relabeling or Defining Interest Areas}
...
```{r, eval= TRUE, echo=TRUE, results='asis', error=TRUE, purl=FALSE}
...
Please refer to the [Basic Preprocessing](VWPre_Basic_Preprocessing.html) vignette for further details.
